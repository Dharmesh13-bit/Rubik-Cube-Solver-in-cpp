...
int Cross::checkCross(Cube &cube) { //must check if in correct position as well
  if (!cube.cubes[1][0] && !cube.cubes[3][0] && !cube.cubes[5][0] && !cube.cubes[7][0] && cube.cubes[7][2] == 2 && cube.cubes[7][3] == 3 && cube.cubes[7][4] == 4 && cube.cubes[7][5] == 5) {
    return 0;
  }
  else
    return 1;
      ...
      if (cube.cubes[edge][side] == 0) {
        ...
        switch (side) {
          ...
          case 0:
            if (edge == 1) {
              if (cube.cubes[7][2] != 2) {
                while (cube.cubes[1][2] == 0 || cube.cubes[7][1] == 0) {
                  cube.moves("U");
                }
                cube.moves("FF");
              }
              ...
              if (cube.cubes[7][3] != 3) {
                while (cube.cubes[1][3] == 0 || cube.cubes[5][1] == 0) {
                  cube.moves("U");
                }
                cube.moves("RR");
              }
              ...
              if (cube.cubes[7][4] != 4) {
                while (cube.cubes[1][3] == 0 || cube.cubes[1][1] == 0) {
                  cube.moves("U");
                }
                cube.moves("BB");
              }
              ...
              if (cube.cubes[7][5] != 5) {
                while (cube.cubes[1][5] == 0 || cube.cubes[3][1] == 0) {
                  cube.moves("U");
                }
                cube.moves("LL");
              }
